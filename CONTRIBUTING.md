We welcome contributions. Everybody is invited to contribute any material, which will ease and / or reduce the effort of OSS license compliance activities. A contribution can be a Debian copyright file, a SPDX document or any other "machine & human friendly" format of an OSS package analysis file.
...
If you want to contribute to the project please read the following short paragraphs.

## How to contribute?
Like any other state of the art OSS project, we need a prove that all contributions are contributed with the right and allowance to do so.
...
We use a very similar procedure like it is implemented for the Linux kernel development, because we think that this procedure is proven that it functions and that it is not a hurdle which hinders contributions. If you want to check how the Linux Kernel handles it, it is described at "Sign Off" for 
[Linux kernel development](https://www.kernel.org/doc/Documentation/process/submitting-patches.rst) section 11) Sign your work - the Developer's Certificate of Origin.
...
If you are still uncertain how and what to contribute or if you want to make a contribution, without being disclosed as contributor, send [me](mailto:ofendt@googlemail.com) an email 